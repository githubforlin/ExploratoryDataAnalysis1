...
win.graph(200,200)
with(df, plot(DateTime, Sub_metering_1, type = "n", xlab = "datetime", ylab = "Energy sub metering" , axes = F, frame.plot=TRUE))
...
legend("topright", 
 ...
 bty = "n",lwd=2, cex=1.1,y.intersp=1.4, col=c("black","red","blue"), lty=c(1,1,1))